<template>
    ...
    <div class="relative">
        <button @click="isOpen = !isOpen"
            ...
            <span class="text-sm">{{ currentLanguage === 'fr' ? '🇫🇷 FR' : '🇬🇧 EN' }}</span>
        </button>

        <!-- Menu déroulant -->
        <div v-if="isOpen"
            class="absolute right-0 mt-2 w-48 rounded-lg shadow-lg bg-amber-200 dark:bg-red-400 ring-1 ring-black ring-opacity-5 z-50">
